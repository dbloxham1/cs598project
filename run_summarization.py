...
def run_summarization(
    ...
    demonstrations = read_jsonl(
        f"/content/drive/MyDrive/summarization_data/{what_for}_{task_id}_in-context.json"
    )
    test_examples = read_jsonl(f"/content/drive/MyDrive/summarization_data/{what_for}_{task_id}_test.json")
    ...
    if save_path is None:
        save_path = f"/content/drive/MyDrive/summarization_results/{model_name}_{what_for}{task_id}_results_prompt{prompt_id}_{n_shot}shot.jsonl"
